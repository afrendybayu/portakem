...
Ext.define('rcm.view.kalender.CalendarPanel', {	
    extend: 'Ext.panel.Panel',
    alias: 'widget.calendarpanel',
    
    requires: [
        'Ext.layout.container.Card',
        'rcm.view.kalender.view.Day',
        'rcm.view.kalender.view.Week',
        'rcm.view.kalender.view.Month',
        'rcm.view.kalender.form.EventDetails',
        'rcm.view.kalender.data.EventMappings'
    ],
